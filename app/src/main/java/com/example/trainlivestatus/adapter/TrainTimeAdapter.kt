        ...
        holder.binding.apply {
            ...
            list[position].also {
                ...
                if (it.jsonMember1A != null) {
                    ...
                    val str_1date = timeage(it.jsonMember1A.cacheTime)
                ...
                if (it.jsonMember2A != null) {
                    ...
                    val str_2date = timeage(it.jsonMember2A.cacheTime)
                ...
                if (it.jsonMember3A != null) {
                    ...
                    val str_3date = timeage(it.jsonMember3A.cacheTime)
                ...
                if (it.sL != null) {
                    ...
                    val str_sldate = timeage(it.sL.cacheTime)
...
*//*
    ...
    fun setDateFormat(unformattedDate: String?): String? {
        @SuppressLint("SimpleDateFormat") val dateformat =
            SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss").parse(unformattedDate)
    ...
    fun timeage(settime: String?): String? {
        ...
        var date: Date? = null
        try {
            date = formatter.parse(settime) as Date
            var output: Long = 0
