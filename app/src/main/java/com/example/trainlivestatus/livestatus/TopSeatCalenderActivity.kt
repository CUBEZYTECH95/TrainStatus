...
class TopSeatCalenderActivity : AppCompatActivity() {
        ...
        if (intent != null) {
            ...
            if (intent.getIntExtra("type", 0) == 1) {
                ...
                if (getIntent().getStringExtra("mon") == "Y") {
                    binding.tvDay.monday.setTextColor(applicationContext.resources.getColor(R.color.colore_d))
                } else {
                    binding.tvDay.monday.setTextColor(applicationContext.resources.getColor(R.color.colorGray))
                }
                if (getIntent().getStringExtra("tue") == "Y") {
                    binding.tvDay.t.setTextColor(applicationContext.resources.getColor(R.color.colore_d))
                } else {
                    binding.tvDay.t.setTextColor(applicationContext.resources.getColor(R.color.colorGray))
                }
                if (getIntent().getStringExtra("wed") == "Y") {
                    binding.tvDay.w.setTextColor(applicationContext.resources.getColor(R.color.colore_d))
                } else {
                    binding.tvDay.w.setTextColor(applicationContext.resources.getColor(R.color.colorGray))
                }
                if (getIntent().getStringExtra("thu") == "Y") {
                    binding.tvDay.th.setTextColor(applicationContext.resources.getColor(R.color.colore_d))
                } else {
                    binding.tvDay.th.setTextColor(applicationContext.resources.getColor(R.color.colorGray))
                }
                if (getIntent().getStringExtra("fri") == "Y") {
                    binding.tvDay.f.setTextColor(applicationContext.resources.getColor(R.color.colore_d))
                } else {
                    binding.tvDay.f.setTextColor(applicationContext.resources.getColor(R.color.colorGray))
                }
                if (getIntent().getStringExtra("sat") == "Y") {
                    binding.tvDay.s.setTextColor(applicationContext.resources.getColor(R.color.colore_d))
                } else {
                    binding.tvDay.s.setTextColor(applicationContext.resources.getColor(R.color.colorGray))
                }
                if (getIntent().getStringExtra("sun") == "Y") {
                    binding.tvDay.su.setTextColor(applicationContext.resources.getColor(R.color.colore_d))
                } else {
                    binding.tvDay.su.setTextColor(applicationContext.resources.getColor(R.color.colorGray))
                }
    ...
    fun topitemcall() {
        ...
        mainViewModel.topseatcalander(sourceCode, destinationCode, date, "ZZ", "4c266f54-988a-477d-bd6c-4981c124a80a", true, "en", true)
    ...
    fun bottomcall(speakfromlangcode: String) {
        ...
        mainViewModel.tarintimecalander(trainNo, sourceCode, destinationCode, date, "1A,2A,3A,SL", speakfromlangcode, CommonUtil.api_key)
